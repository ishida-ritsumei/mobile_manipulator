...
def thesis_pose():
    ...
    target_pose.position.y = 0.500
    target_pose.position.z = 0.03400251924164405
    target_pose.orientation.x = -0.9999072837831338
    target_pose.orientation.y = -4.859141964351074e-05
    target_pose.orientation.z = 0.013613290340705797
    target_pose.orientation.w = 0.00031591519361944936
...
def openhand():
    xarm.detach_object(name="xarm_gripper_base_link")
...
def add_cylinder():
    ...
    pet_pose.pose.position.y=0.200
...
def approach(pet_pose):
    ...
    target_pose.position.z = pet_pose.pose.position.z 
