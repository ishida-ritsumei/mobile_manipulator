...
class lidar_data:
    ...
    def __init__(self):
        ...
        self.odom_sub_2 = rospy.Subscriber('/scan_2', LaserScan, self.lidar_callback_2)
    ...
    def main(self):
        ...
        x_vel  = float(input ("Input x velocity [m/s] :"))
        y_vel = float(input ("Input y velocity [m/s]:"))
